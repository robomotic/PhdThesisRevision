...
The \textbf{Maxcorr} \nomenclature{Maxcorr}{An input measure based on the the correlation of thee organism's inputs} measure can then be normalised by using a logarithmic approach
to express the learning performance in terms of bits and thus is called \textbf{AI measure} .
The simplicity of the AI measure \nomenclature{AI}{Anticipatory Information, an input measure based on the Shannon's entropy measure} derives from the dependency on the
...
The software used to simulate the agents is Enki \nomenclature{Enki}{An open source simulation engine for mobile robots developed by EPFL, URL http://home.gna.org/enki/}
...
\begin{figure}[htbp]
  \begin{center}
 	...
 	\includegraphics[width=0.7 \textwidth]{figures/infomeasure/N2/maxcorr_N=0_w=600.eps}}
      \subfigure[Energy $E(xcorr_{d}(k))$ for left (straight) and right (dashed) synapses. Measures from agent 0.\label{fig:energy1N2M2}]{
	\includegraphics[width=0.7 \textwidth]{figures/infomeasure/N2/power_xcorr_N=0_w=600.eps}}
    \caption[Max correlation for two learning agents]{Information measure analysis for $N=2$ agents
	      ...
	      Learning is switched on for all agents when ($k>1$). \label{fig:N2M2a}}
  \end{center}
\end{figure}
...
\begin{figure}[htbp]
  \begin{center}
	...
	\includegraphics[width=0.7 \textwidth]{figures/infomeasure/N2/maxcorr_N=1_w=600.eps}}
	...
	\includegraphics[width=0.7 \textwidth]{figures/infomeasure/N2/power_xcorr_N=1_w=600.eps}}
    \caption[Max correlation for two learning agents]{Information measure analysis for $N=2$ agents
	      and $M=2$ obstacles computed in $k=1,...,11$ time windows.
...
\begin{figure}[htbp]
  \begin{center}
	...
	\includegraphics[width=0.7 \textwidth]{figures/infomeasure/N4/maxcorr_N=0_w=600.eps}}
	...
	\includegraphics[width=0.7 \textwidth]{figures/infomeasure/N4/power_xcorr_N=0_w=600.eps}}
...
\begin{figure}[htbp]
  \begin{center}
\subfigure[Cross correlation maximum $M(c_{d}(k))$ for left (straight) and right (dashed) synapses. Measures from agent 1.]{
	\includegraphics[width=0.7 \textwidth]{figures/infomeasure/N4/maxcorr_N=1_w=600.eps}}
	...
	\includegraphics[width=0.7 \textwidth]{figures/infomeasure/N4/power_xcorr_N=1_w=600.eps}}
    \caption[Max correlation for 4 learning agents A]{
      Information measure analysis for $N=4$ agents and $M=2$ obstacles computed
      in $k=1,...,11$ time windows. Learning is switched on for all agents
      when ($k>1$).\label{fig:N4M2a2}}
  \end{center}
\end{figure}
...
\subfigure[Cross correlation maximum $M(c_{d}(k))$ for left (straight) and right (dashed) synapses. Measures from agent 2.\label{fig:eqlearning}]{
	\includegraphics[width=0.7 \textwidth]{figures/infomeasure/N4/maxcorr_N=2_w=600.eps}}
	\hspace{1pt}
      \subfigure[Energy $E(xcorr_{d}(k))$ left (straight) and right (dashed) synapses. Measures from the agent 2.\label{fig:energypeak} ]{
	\includegraphics[width=0.7 \textwidth]{figures/infomeasure/N4/power_xcorr_N=2_w=600.eps}}
    \caption[Max correlation for 4 learning agents B]{
	Information measure analysis for $N=4$ agents and $M=2$ obstacles computed
	in $k=1,...,11$ time windows. Learning is switched on for all agents
	when ($k>1$). \label{fig:N4M2b1}}
  \end{center}
\end{figure}
...
\subfigure[Cross correlation maximum $M(c_{d}(k))$ for left (straight) and right (dashed) synapses. Measures from agent 3.]{
	\includegraphics[width=0.7 \textwidth]{figures/infomeasure/N4/maxcorr_N=3_w=600.eps}}
	\hspace{1pt}
	...
	\includegraphics[width=0.7 \textwidth]{figures/infomeasure/N4/power_xcorr_N=3_w=600.eps}}
    \caption[Max correlation for 4 learning agents B]{
	Information measure analysis for $N=4$ agents and $M=2$ obstacles computed
	in $k=1,...,11$ time windows. Learning is switched on for all agents
