...
and in Appendix \ref{Appendix:simulation} there are some code examples taken from
 ...
 of a real Alice \nomenclature{Alice}{A mobile robot produced by EPFL} or Kephera robot \nomenclature{Kephera}{A mobile robot produced by KTeam}
